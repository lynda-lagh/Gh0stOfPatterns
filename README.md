...
| **Languages & ML** | **Big Data & Databases** | **Dev & Design Tools** |
|---|---|---|
| Python · PyTorch · TensorFlow | Hadoop · Kafka · Elasticsearch | Docker · Git · Firebase |
| Scikit-learn · OpenCV · Pandas | MongoDB · PostgreSQL · MySQL | React · Tailwind CSS · Figma |
| Seaborn · Matplotlib | SQLite · Redis | Photoshop · Illustrator |
